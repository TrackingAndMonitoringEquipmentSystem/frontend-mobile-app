...
import 'core/injection/injectable_module.dart' as _i20;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i17.RegisterEnterPhoneNumberBloc>(() =>
      _i17.RegisterEnterPhoneNumberBloc(get<_i12.AuthenticationRepository>()));
  gh.factory<_i18.SignInFormBloc>(
      () => _i18.SignInFormBloc(get<_i12.AuthenticationRepository>()));
  gh.factory<_i19.AuthenBloc>(
      () => _i19.AuthenBloc(get<_i12.AuthenticationRepository>()));
  return get;
}
