...
class AddOrEditLockerPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ValueNotifier<List<Department>> departmentsSelected = useState([]);
    void Function()? floorClear;
    void Function()? roomClear;
    final lockerRepository = getIt<LockerRepository>();
    final isShowErrorMessage = useState(false);
                    ...
                    Row(
                      children: [
                        InputText(
                          ...
                          isError:
                              isShowErrorMessage.value && name.value.isEmpty,
                    ...
                    Row(
                      children: [
                        InputText(
                          ...
                          isError: isShowErrorMessage.value &&
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        BottomSheetMultipleSelect<Department>(
                          label: 'แผนก',
                          placeHolder: 'แผนก',
                          onChanged: (value) {
                            departmentsSelected.value = value;
                          },
                          listChoice: departments.value
                              ...
                              .toList(),
                          isError: isShowErrorMessage.value &&
                              departmentsSelected.value.isEmpty,
                          errorMessage: 'กรุณาเลือกค่า',
                        ),
                      ],
                    ),
                          ...
                          Button(
                            ...
                            onPressed: () async {
                              ...
                              if (isInputValid(
                                ...
                                result.fold((l) => handleErrorCase(context, l),
                                    (r) {
                                  lockerRepository.currentLocker = r;
                                  AutoRouter.of(context).replace(
                                    AllEquipmentRoute(
                                      lockerId:
                                          lockerRepository.currentLocker!.id,
                                    ),
                                  );
                                });
                              }
