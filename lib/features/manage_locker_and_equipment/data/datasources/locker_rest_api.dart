...
class LockerRestApi {
  ...
  Future<Either<RestFailure, Map<String, dynamic>>> userViewLockers(
    ...
    try {
      final uri = Uri(
        ...
        host: environment.baseApiUrl,
        port: environment.baseApiPort,
        path: environment.lockers[environment.LockerPath.userViewLockers],
      );
  ...
  Future<Either<RestFailure, Map<String, dynamic>>> userViewEquipments({
    required String token,
  }) async {
    try {
      final uri = Uri(
        ...
        port: environment.baseApiPort,
        path: environment
            .typeEquipment[environment.TypeEquipmentPath.userViewEquipments],
      );
  ...
  Future<Either<RestFailure, Map<String, dynamic>>> listGroupBorrow({
    required String token,
  }) async {
    try {
      final uri = Uri(
